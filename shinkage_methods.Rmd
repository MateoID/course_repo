...
```{r}
require("pacman")
p_load("tidyverse","stargazer", "glmnet", "caret")
...
```
glmnet permite calcular el valor de los coeficientes usando múltiples valores de lambda, cuando no se especifica ese argumento en la función. 
En la gráfica es posible apreciar el valor que van tomando los coeficientes a medida que aumenta el valor de lambda (ln lambda).
```{r}
ridge2 <- glmnet(
  x = Xsmall,
  y = y,
